...
public class BankController {
	...
	public ResponseEntity<String> register(@RequestBody Bankdto banks) {
		String output =bankService.createBank(banks);
		
		return new ResponseEntity<>(output,HttpStatus.OK);
	}
	
	@PutMapping(value = "/updateBank/{id}")
	public ResponseEntity<String> update(@PathVariable(value="id")Long bank_id,@RequestBody Bankdto banks) {
		String output =bankService.updateBank(banks,bank_id);
		
		return new ResponseEntity<>(output,HttpStatus.OK);
	}
	@DeleteMapping(value = "/deletebank")
	public ResponseEntity<String> delete(@RequestParam(value = "bankid") Long bank_id) {
		String output =bankService.deleteBank(bank_id);
